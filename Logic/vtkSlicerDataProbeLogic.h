...
public:
  ...
  enum DataProbeStatus
  {
    ...
    WARNING_LABEL_VOLUME_UNKNOWN_LABELNAME = 0x100,

    SUCCESS_DTI_VOLUME    = DTI_VOLUME    | SUCCESS,
    SUCCESS_SCALAR_VOLUME = SCALAR_VOLUME | SUCCESS,
    SUCCESS_LABEL_VOLUME  = LABEL_VOLUME  | SUCCESS,
    SUCCESS_LABEL_VOLUME_UNKNOWN_LABELNAME = WARNING_LABEL_VOLUME_UNKNOWN_LABELNAME | LABEL_VOLUME | SUCCESS,

    ERROR_NO_SCALAR_VOLUME   = 0x1  * 10000 | ERROR,
    ERROR_NO_IMAGE_DATA      = 0x2  * 10000 | SCALAR_VOLUME | ERROR,
    ERROR_OUT_OF_FRAME       = 0x4  * 10000 | SCALAR_VOLUME | ERROR,
    ERROR_DTI_NO_POINT_DATA  = 0x8  * 10000 | DTI_VOLUME | ERROR,
    ERROR_DTI_NO_TENSOR_DATA = 0x10 * 10000 | DTI_VOLUME | ERROR
  };
